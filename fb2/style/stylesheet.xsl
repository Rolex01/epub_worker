<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fb="http://www.gribuser.ru/xml/fictionbook/2.0">
	...
	<xsl:param name="cssfile" select="style.css" />		
	...
	<xsl:template match="fb:a">
		<xsl:element name="span"><!--a-->
			<xsl:attribute name="class">htooltip</xsl:attribute>
		...
		<html>
			<head>
				...
				<xsl:element name="link">			
					<xsl:attribute name="href">style.css<!--xsl:value-of select="$cssfile" /--></xsl:attribute>
